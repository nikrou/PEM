...
{
	case 'mysql':
		require $root_path.'include/dblayer/mysql.php';
		break;
	...
	default:
		error('\''.$conf['db_params']['type'].'\' is not a valid database type. Please check settings in config.php.', __FILE__, __LINE__);
		break;
}
